...
**1. Clone the repository**
```bash
git clone https://github.com/farihaabbasi06/Lumio.git
cd lumio
```
...
This project was developed as part of a university semester project and is intended for educational purposes.
