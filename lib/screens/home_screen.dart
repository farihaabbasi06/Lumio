...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // Main pages only.
  // ExamSim opens as a separate screen.
  final List<Widget> _pages = [
    const SubjectsDashboardView(),
    const GlobalFlashcardsView(),
    const ExamPredictorScreen(),
    ...
    return Scaffold(
              ...
              actions: [
                IconButton(
                  icon: Icon(
                    ...
                    color: colors.textPurple == Colors.white
                        ? colors.primary
                        : colors.textPurple,
                  ),
                  onPressed: () async {
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          ...
          // Profile is now the LAST navigation item,
          // but internally it is still page index 3.
          if (index == 4) {
            setState(() {
              _currentIndex = 3;
            });
      ...
      floatingActionButton: _currentIndex == 0
          ? FloatingActionButton(
              ...
              onPressed: () =>
                  _showAddSubjectDialog(context, colors),
              child: const Icon(
                Icons.add,
                size: 28,
              ),
